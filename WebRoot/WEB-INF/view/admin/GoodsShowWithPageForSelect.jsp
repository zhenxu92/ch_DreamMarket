								...
								<tbody>
									<s:iterator value="#session.selectGoods" var="goods" status="st">
										<tr>
											...
											<td align="left"><a href='/ch_DreamMarket/admin/selectGoodsDetails.action?gno=<s:property value="#goods.gno"/>');" src='<s:property value="#goods.gpicture"/>'
													style="border:0;cursor:pointer;background-color:white;">查看详情</a></td>
								...
								<nav class="page">
									<ul class="pagination">
										<s:if test="#session.pageResult.page.hasPrePage">
											<li><a href="pageOnChangeForSelect.action?currentPage=1">«</a></li>
							                <li><a href="pageOnChangeForSelect.action?currentPage=${pageResult.page.currentPage-1 }"><</a></li>
										</s:if>
										<s:else>
										...
										for(int i=begin;i<=end;i++){
									     ...
									     %>
									           <li><a href='pageOnChangeForSelect.action?currentPage=<%=i%>'><%=i%></font></a></li>   
									     <%	  
										     }
										}
									     %>
									     <s:if test="#session.pageResult.page.hasNextPage">
											<li><a href="pageOnChangeForSelect.action?currentPage=${pageResult.page.currentPage+1 }">></a></li>
							                <li><a href="pageOnChangeForSelect.action?currentPage=${pageResult.page.totalPage }">»</a><li>
										</s:if>
